# Gerenciamento de Ameaças Cibernéticas   <img src="./0-aux/logo_course.png" alt="curso_150" width="auto" height="45">
...
0. <a href="#item00">Introdução ao curso</a><br>
  0.1 <a href="#item00.01">Primeira vez neste curso</a><br>
  0.2 <a href="#item00.02">Baixe e Instale o Packet Tracer</a><br>
  0.3 <a href="#item00.03">Introdução ao Cisco Packet Tracer</a><br>
  0.4 <a href="#item00.04">Packet Tracer como uma ferramenta de aprendizagem adaptável</a><br>
  0.5 <a href="#item00.05">Packet Tracer - Exploração dos Modos Lógico e Físico</a><br>
...
<a name="item05.02"><h4>5.2 Gerenciamento de risco</h4></a>[Back to summary](#item04)
...
<a name="item05.03"><h4>5.3 Avaliação de risco</h4></a>[Back to summary](#item04)





<a name="item05.04"><h4>5.4 Controles de segurança</h4></a>[Back to summary](#item04)


<a name="item05.05"><h4>5.5 Resumo de Gerenciamento de riscos e controles de segurança</h4></a>[Back to summary](#item04)