...
aws_cli_path = "G:/Meu Drive/4_PROJ/scripts/scripts_model/.default/aws/secrets/awscli/iamUserWorker"
aws_cli_folder = ".aws"
docker_path = "G:/Meu Drive/4_PROJ/scripts/scripts_model/.default/aws/secrets/docker/aws"
...
if resposta.lower() == 'y':
    ...
    if instances:
        ...
        folderExists = subprocess.getoutput(f'ssh -i "{key_pair_path}/{key_pair_name}.pem" -o StrictHostKeyChecking=no ubuntu@{ip_ec2} "{cmd}"')
