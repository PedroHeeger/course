...
user_data_path = "G:/Meu Drive/4_PROJ/course/aws_skill_builder/aws/curso_106/resources/aws_dock_zsh/"
...
if resposta.lower() == 'y':
    try:
        ...
        if instances:
            ...
            security_group_id = list(ec2.security_groups.filter(Filters=[{'Name': 'group-name', 'Values': [sg_name]}]))[0].id
